...
tableCooking <- monday %>%
  ...
  filter(Activity != "Rest") %>%
  filter(Activity != "Work") %>%
  filter(Activity %in% c("Cooking (breakfast)", 
                         "Cooking (business)", 
                         "Cooking (baby)",
                         "Cooking (lunch)",
                         "Cooking (dinner)",
...
MonCook <- ggplot(tableCooking, aes(x = fixedHMS, y = n)) + geom_bar(stat = "identity", position = "stack", color="blue", fill="blue") +
  ...
  ylab("n") + theme(plot.title = element_text(color="Black", size=11, face="bold.italic", hjust=0.5,lineheight=0.8),
        ...
        axis.text.x = element_text(angle = 90, vjust=0.5, size = 8), #turn scale 90 degree
...
MonCookpropPlot <- ggplot(MonCookprop, aes(x = fixedHMS, y = Percentage)) + geom_bar(stat = "identity", position = "stack", color="blue", fill="blue") +
  ggtitle("Monday Cooking") +
  xlab("Time ") +
  ylab("Percentage") + 
  theme(plot.title = element_text(color="Black", size=11, face="bold.italic", hjust=0.5,lineheight=0.8),
        axis.title.x = element_text(color="black", size=10, face="bold"),
        axis.title.y = element_text(color="black", size=10, face="bold"),
        axis.text.x = element_text(angle = 90, vjust=0.5, size = 8), #turn scale 90 degree
        panel.background=element_rect(fill = "white"),
...
# Monday report cooking
MonCookingreport <- monday %>%
  select('Household ID', Activity) %>% 
  filter(Activity != "Sleeping") %>%
  filter(Activity != "Rest") %>%
  filter(Activity != "Work") %>%
  filter(Activity %in% c("Cooking (breakfast)", 
...
#plot 
TueCookpropPlot <- ggplot(TueCookingprop, aes(x = fixedHMS, y = Percentage)) + geom_bar(stat = "identity", position = "stack", color="blue", fill="blue", alpha=0.5) +
  ggtitle("Tuesday Cooking") +
  xlab("Time") +
  ylab("Percentage") + theme(plot.title = element_text(color="Black", size=11, face="bold.italic", hjust=0.5,lineheight=0.8),
        axis.title.x = element_text(color="black", size=10, face="bold"),
        axis.title.y = element_text(color="black", size=10, face="bold"),
        panel.background=element_rect(fill = "white"),
        panel.grid.minor = element_blank(),
...
#Tuesday report cooking
TueCookingreport <- tuesday %>%
  select('Household ID', Activity) %>% 
  filter(Activity != "Sleeping") %>%
  filter(Activity != "Rest") %>%
  filter(Activity != "Work") %>%
...
# Wednesday report cooking
WedCookingreport <- wednesday %>%
  select('Household ID', Activity) %>% 
  filter(Activity != "Sleeping") %>%
  filter(Activity != "Rest") %>%
  filter(Activity != "Work") %>%
...
# Thursday report cooking
ThuCookingreport <- thursday %>%
  select('Household ID', Activity) %>% 
  filter(Activity != "Sleeping") %>%
  filter(Activity != "Rest") %>%
  filter(Activity != "Work") %>%
...
# Friday report cooking
FriCookingreport <- friday %>%
  select('Household ID', Activity) %>% 
  filter(Activity != "Sleeping") %>%
  filter(Activity != "Rest") %>%
  filter(Activity != "Work") %>%
...
# Weekdays report cooking
WkdCookingreport <- newdata %>%
  select('Household ID', Activity) %>% 
  filter(Activity != "Sleeping") %>%
  filter(Activity != "Rest") %>%
  filter(Activity != "Work") %>%
...
mondayDT[, ba_act := ifelse(Activity %in% c("Cooking (breakfast)", 
                         "Cooking (business)", 
                         "Cooking (baby)",
                         "Cooking (lunch)",
                         "Cooking (dinner)",
...
allDaysDT[, ba_act := ifelse(Activity %in% c("Cooking (breakfast)", 
                         "Cooking (business)", 
                         "Cooking (baby)",
                         "Cooking (lunch)",
                         "Cooking (dinner)",
...
# plot
ggplot2::ggplot(groupbygen, aes(x = Gender, y = Percentage)) +
  geom_col() + theme(plot.title = element_text(color="Black", size=11, face="bold.italic", hjust=0.5,lineheight=0.8),
        axis.title.x = element_text(color="black", size=10, face="bold"),
        axis.title.y = element_text(color="black", size=10, face="bold"),
        axis.text.x = element_text(angle = 90, vjust=0.5, size = 8), #turn scale 90 degree
        panel.background=element_rect(fill = "white"),
...
# plot
ggplot2::ggplot(groupbyage, aes(x = Age, y = Percentage)) +
  geom_col() + theme(plot.title = element_text(color="Black", size=11, face="bold.italic", hjust=0.5,lineheight=0.8),
        axis.title.x = element_text(color="black", size=10, face="bold"),
        axis.title.y = element_text(color="black", size=10, face="bold"),
        axis.text.x = element_text(angle = 90, vjust=0.5, size = 8), #turn scale 90 degree
...
# plot
ggplot2::ggplot(groupbyedu, aes(x = Education, y = Percentage)) +
  geom_col() + theme(plot.title = element_text(color="Black", size=11, face="bold.italic", hjust=0.5,lineheight=0.8),
        axis.title.x = element_text(color="black", size=10, face="bold"),
        axis.title.y = element_text(color="black", size=10, face="bold"),
        axis.text.x = element_text(angle = 90, vjust=0.5, size = 8), #turn scale 90 degree
...
# plot
ggplot2::ggplot(groupbyrel, aes(x = Religion, y = Percentage)) +
  geom_col() + theme(plot.title = element_text(color="Black", size=11, face="bold.italic", hjust=0.5,lineheight=0.8),
        axis.title.x = element_text(color="black", size=10, face="bold"),
        axis.title.y = element_text(color="black", size=10, face="bold"),
        axis.text.x = element_text(angle = 90, vjust=0.5, size = 8), #turn scale 90 degree
...
# plot
ggplot2::ggplot(groupbymar, aes(x = Martial_Status, y = Percentage)) +
  geom_col() 
````
...
# plot
ggplot2::ggplot(groupbyjob, aes(x = Employment_Classification, y = Percentage)) +
  geom_col() + theme(plot.title = element_text(color="Black", size=11, face="bold.italic", hjust=0.5,lineheight=0.8),
        axis.title.x = element_text(color="black", size=10, face="bold"),
        axis.title.y = element_text(color="black", size=10, face="bold"),
        axis.text.x = element_text(angle = 90, vjust=0.5, size = 8), #turn scale 90 degree
...
# plot
ggplot2::ggplot(groupbyhmem, aes(x = Household_members, y = Percentage)) +
  geom_col() 
...
# plot
ggplot2::ggplot(groupbyinc, aes(x = Income_earners, y = Percentage)) +
  geom_col() 
...
# plot
ggplot2::ggplot(groupbyfort, aes(x = Fortnight_income, y = Percentage)) +
  geom_col() + theme(plot.title = element_text(color="Black", size=11, face="bold.italic", hjust=0.5,lineheight=0.8),
        axis.title.x = element_text(color="black", size=10, face="bold"),
        axis.title.y = element_text(color="black", size=10, face="bold"),
        axis.text.x = element_text(angle = 90, vjust=0.5, size = 8), #turn scale 90 degree
...
# plot
ggplot2::ggplot(groupbyvil, aes(x = Village, y = Percentage)) +
  geom_col() + theme(plot.title = element_text(color="Black", size=11, face="bold.italic", hjust=0.5,lineheight=0.8),
        axis.title.x = element_text(color="black", size=10, face="bold"),
        axis.title.y = element_text(color="black", size=10, face="bold"),
        axis.text.x = element_text(angle = 90, vjust=0.5, size = 8), #turn scale 90 degree
...
#filter Household that report cooking
c <- filter(b,`Household ID` %in% c(2,8,10,17,19,20,23,24,25,37,41,47,56,60,61,63,64,66,68,71,72,76,77,85,87,89,94,95,98,99))
c

c1 <- filter(b,!`Household ID` %in% c(2,8,10,17,19,20,23,24,25,37,41,47,56,60,61,63,64,66,68,71,72,76,77,85,87,89,94,95,98,99))
c1

d <- c %>% select(Gender, Martial_Status)
d

d1 <- c1 %>% select(Gender, Martial_Status)
d1

#filter Household by gender
...
plotcookbygen <- ggplot2::ggplot(cookbygen, aes(x = Gender, y = Percentage)) +
  geom_col() + theme(plot.title = element_text(color="Black", size=11, face="bold.italic", hjust=0.5,lineheight=0.8),
        axis.title.x = element_text(color="black", size=10, face="bold"),
        axis.title.y = element_text(color="black", size=10, face="bold"),
        axis.text.x = element_text(angle = 90, vjust=0.5, size = 8), #turn scale 90 degree
...
plotcookbyfem <- ggplot2::ggplot(cookfemale, aes(x = Martial_Status, y = Percentage)) +
  geom_col() + theme(plot.title = element_text(color="Black", size=11, face="bold.italic", hjust=0.5,lineheight=0.8),
        axis.title.x = element_text(color="black", size=10, face="bold"),
        axis.title.y = element_text(color="black", size=10, face="bold"),
        axis.text.x = element_text(angle = 90, vjust=0.5, size = 8), #turn scale 90 degree
...
plotcookbymale <- ggplot2::ggplot(cookmale, aes(x = Martial_Status, y = Percentage)) +
  geom_col() + theme(plot.title = element_text(color="Black", size=11, face="bold.italic", hjust=0.5,lineheight=0.8),
        axis.title.x = element_text(color="black", size=10, face="bold"),
        axis.title.y = element_text(color="black", size=10, face="bold"),
        axis.text.x = element_text(angle = 90, vjust=0.5, size = 8), #turn scale 90 degree
